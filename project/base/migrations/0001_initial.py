# Generated by Django 3.2.19 on 2023-05-29 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('category', models.CharField(choices=[('Electronics and Computers', 'ELEC'), ('Cars', 'CAR'), ('Bid Packs', 'BID'), ('Home, Garden and Tools', 'HOME'), ('Fashion, Health and Beauty', 'FASHION'), ('Gift Cards', 'CARD'), ('Kitchen and Dining', 'KITCHEN'), ('Other', 'OTHER')], max_length=50)),
